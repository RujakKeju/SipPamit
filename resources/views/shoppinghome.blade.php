    ...
    <header class="header-section">
        ...
        <div class="inner-header">
          <div class="row">
            <div class="col-lg-2 col-md-2">
              <div class="logo">
                <a href="./index.html">
                  <img style="height: 50px; border-radius: 50px;" src="img/sipamit logo.jpg" alt="" />
                </a>
              </div>
            </div>
      ...
      <div class="nav-item">
        <div class="container">
          <div class="nav-depart">
            <div class="depart-btn">
              ...
              <ul class="depart-hover">
                ...
                <li><a href="#">SEMPAK LUCKY</a></li>
                <li><a href="#">Kid's Clothing</a></li>
                <li><a href="#">DAVID BAU TAHI</a></li>
          ...
          <!-- NAVBAR GES NAVBAR KALOAI KD MELIAT -->
